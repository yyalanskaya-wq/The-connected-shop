describe('WordPress REST API Posts Endpoint', () => {
  ...
  //           const categoryId = categoriesResponse.body[1].id
  //           cy.request({
  //             method: 'GET',
  //             url: POSTS_ENDPOINT,
  //             qs: {
  ...
  //       expect(response.body).to.be.an('object').to.have.property('code')
  //       expect(response.body.code).to.include('rest_post_invalid_page_number')
  //     })
  //   })
